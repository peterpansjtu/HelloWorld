...
class FinsTCPFrame():
    def __init__(self, cmdData='', rawFinsCmd=None, cmdFlags=None, DA1=None, SA1=None, MRC=None, SRC=None, command=0x02,
...
class OmronPLC():
    ...
    def openFins(self, address, port=9600):
        ...
        if (self.plcType):
            print('Open successfully to ', self.plcType, 'at ', address)
        else:
